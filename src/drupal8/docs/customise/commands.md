...
There are also a number of [default commands](https://github.com/inviqa/harness-base-php/blob/1.3.x/src/_base/harness/config/commands.yml) available that may already provide the functionality you require.
