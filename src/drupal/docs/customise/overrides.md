...
To understand more, take a look at the tasks in the `console` docker image [here](https://github.com/inviqa/harness-base-php/blob/2.0.x/src/_base/docker/image/console/root/usr/lib/task)

[harness.yml]: ../../harness.yml
[common.yml]: https://github.com/inviqa/harness-base-php/blob/2.0.x/src/_base/harness/attributes/common.yml
