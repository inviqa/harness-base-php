...
To understand more, take a look at the tasks in the `console` docker image [here](https://github.com/inviqa/harness-base-php/blob/1.6.x/src/_base/docker/image/console/root/lib/task)
